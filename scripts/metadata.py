...
class MetadataMerger:
    ...
    def load_and_concat_metadata(self, input_metadata_path):
        ...
        self.metadata.drop_duplicates(subset=["protein_ID"], inplace=True)
    ...
    def _merge_with_metadata(self, matches):
        ...
        matches.drop(columns=["protein_ID"], inplace=True)  # redundant
        pbar.update(1)
        ...
        matches.drop(columns=["protein_ID", "input_seq_s", "virus_s"], inplace=True, errors="ignore")
        pbar.update(1)
